   ...
   <div id="single-class-content" class="<?php echo $show_loading ? 'd-none' : ''; ?>">
      ...
      <div class="card-body card px-5 mb-3">
            <h5 class="mb-0">
               ...
               <span class="badge ms-2 badge badge-phoenix badge-phoenix-warning " id="notes-count">4 NOTES</span>
            </h5>
            ...
            <div id="notes-display-area">
               ...
               <div id="notes-list">
                  <div class="notes-grid">
                     <div class="note-card priority-high" data-note-id="note_6875094e6d579">
                        <div class="note-card-header">
                           <div class="note-card-categories">
                              <span class="note-category-badge note-category-agent-absent">Agent Absent</span> <span class="note-category-badge note-category-venue-issues">Venue issues</span>
                           </div>
                        ...
                        <div class="note-card-footer">
                           <div class="note-card-meta">
                              <span><i class="bi bi-person"></i> Laudes</span>
                              <span title="14/07/2025 15:42:38"><i class="bi bi-calendar"></i> 5 minutes ago</span>
                           </div>
                        </div>
                     </div>
                     <div class="note-card priority-medium" data-note-id="note_6875086d78610">
                        <div class="note-card-header">
                           <div class="note-card-categories">
                              <span class="note-category-badge note-category-learners-unhappy">Learners unhappy</span> <span class="note-category-badge note-category-client-unhappy">Client unhappy</span>
                           </div>
                           <div class="note-card-metadata">
                           </div>
                        </div>
                        <div class="note-card-body">
                           <div class="note-content-expandable">
                              <div class="note-content-full note-content-collapsed" data-full-content="Emotional intelligence is another “soft” skill that is in very short supply in most industries. Emotionally intelligent supply chain professionals gain the trust and respect of team members, ensuring better collaboration and more successful outcomes across the supply chain.">
                                 Emotional intelligence is another “soft” skill that is in very short supply in most industries. Emotionally intelligent supply chain professionals gain the trust and respect of team members, ensuring ...
                              </div>
                        ...
                        <div class="note-card-footer">
                           <div class="note-card-meta">
                              <span><i class="bi bi-person"></i> Laudes</span>
                              <span title="14/07/2025 15:38:53"><i class="bi bi-calendar"></i> 9 minutes ago</span>
                           </div>
                        </div>
                     </div>
                     <div class="note-card priority-high" data-note-id="note_6875084a75b38">
                        <div class="note-card-header">
                           <div class="note-card-categories">
                              <span class="note-category-badge note-category-material-shortage">Material shortage</span>
                           </div>
                           <div class="note-card-metadata">
                           </div>
                        </div>
                        <div class="note-card-body">
                           <div class="note-content-expandable">
                              <div class="note-content-full note-content-collapsed" data-full-content="The widening skills gap in this industry is due to rapid technological advancement which has outpaced traditional workplace training programmes, exacerbated by the growth in demand for e-commerce and shifting consumer preferences.">
                                 The widening skills gap in this industry is due to rapid technological advancement which has outpaced traditional workplace training programmes, exacerbated by the growth in demand for e-commerce and ...
                              </div>
                              <button type="button" class="note-expand-btn fs-10" onclick="toggleNoteContent(this)">
                              <i class="bi bi-chevron-down me-1"></i>Show More
                              </button>
                        ...
                        <div class="note-card-footer">
                           <div class="note-card-meta">
                              <span><i class="bi bi-person"></i> Laudes</span>
                              <span title="14/07/2025 15:38:18"><i class="bi bi-calendar"></i> 10 minutes ago</span>
                           </div>
                        </div>
                     </div>
                     <div class="note-card priority-low" data-note-id="note_6873c79293436">
                        <div class="note-card-header">
                           <div class="note-card-categories">
                              <span class="note-category-badge note-category-poor-attendance">Poor attendance</span>
                           </div>
                           <div class="note-card-metadata">
                              <div class="dropdown note-attachments-dropdown">
                                 <button class="btn btn-sm btn-outline-secondary dropdown-toggle note-attachments-indicator" type="button" data-bs-toggle="dropdown" aria-expanded="false" title="1 attachment(s)">
                                 <i class="bi bi-paperclip"></i>
                                 <span>1</span>
                                 </button>
                                 <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="http://localhost/wecoza/wp-content/uploads/wecoza-classes/2025/07/toaz.info-forex-ict-amp-mmm-notespdf-pr_62f4bf2dd422bf57eec6ef9f915e116d.pdf" target="_blank" download="toaz.info-forex-ict-amp-mmm-notespdf-pr_62f4bf2dd422bf57eec6ef9f915e116d.pdf">
                                       <i class="bi bi-download me-2"></i>toaz.info-forex-ict-amp-mmm-notespdf-pr_62f4bf2dd422bf57eec6ef9f915e116d.pdf
                                       </a>
                                    </li>
                                 </ul>
                              </div>
                        ...
                        <div class="note-card-body">
                           <div class="note-content-expandable">
                              <div class="note-content-full note-content-collapsed" data-full-content="Generate Ghanaian-style dummy content in one click.
                                 This plugin helps you quickly populate your Figma designs with local names, emails, bios, and pixel avatars—perfect for prototyping profile cards, team sections, or any user-based UI.">
                                 Generate Ghanaian-style dummy content in one click.
                                 This plugin helps you quickly populate your Figma designs with local names, emails, bios, and pixel avatars—perfect for prototyping profile cards, ...
                              </div>
                              <button type="button" class="note-expand-btn fs-10" onclick="toggleNoteContent(this)">
                              <i class="bi bi-chevron-down me-1"></i>Show More
                              </button>
                        ...
                        <div class="note-card-footer">
                           <div class="note-card-meta">
                              <span><i class="bi bi-person"></i> Laudes</span>
                              <span title="13/07/2025 16:49:54"><i class="bi bi-calendar"></i> 22 hours ago</span>
                           </div>
                        </div>
                     </div>
                  </div>
