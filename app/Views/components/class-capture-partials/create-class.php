      ...
      <div class="mb-4 mt-3">
         ...
         <div class="row mb-3">
            ...
            <div class="col-md-12 mb-3" id="day-selection-container">
               <h6 class="small mb-2">Days of Week <span class="text-danger">*</span></h6>
            ...
            <div id="day-time-section-template" class="per-day-time-section col-sm-6 col-md-4 col-lg-3 d-none" data-day="">
               <div class="card h-100 border">
                  <div class="card-body">
                     ...
                     <small class="text-muted day-duration-display mb-1 d-none">Duration: <span class="duration-value badge badge-phoenix badge-phoenix-info">-</span> hours</small>
                  </div>
               </div>
            </div>
         </div>
